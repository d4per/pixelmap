...
![Two photographs of a monkey statue taken from different positions, above three renderings of the correspondence recovered between them](https://raw.githubusercontent.com/d4per/pixelmap/v0.3.0/images/docs/apa.webp)
